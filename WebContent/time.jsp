            ...
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
             <li>
	            ...
	            <li>
	                ...
	                <li>
	                    <a href="/books/history.jsp"><i class="glyphicon glyphicon-chevron-right"></i>定时提醒</a>
	                </li>
            </ul>
        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">定时提醒</div>
                            </div>
    ...
    <div class="row">
                <div class="col-lg-12">
                      <div class="col-lg-4 form-group" style="width:800px;">
                                        <button type="submit" class="btn btn-primary" id="btn_query" >归档提醒</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >特定文档提醒</button>
                                    </div>
                </div>
            </div>
                <div class="row">
