        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    <a class="navbar-brand" href="/reader.jsp"><strong>欢迎使用公文管理系统</strong></a>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-2 bootstrap-admin-col-left">
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                  <li>
                    <a href="/books/select.jsp"><i class="glyphicon glyphicon-chevron-right"></i>基础信息管理</a>
                </li>
	            <li>
	                 <a href="/books/borrow.jsp"><i class="glyphicon glyphicon-chevron-right"></i>公文流转</a>
	                </li>
	                <li>
	                    <a href="/books/history.jsp"><i class="glyphicon glyphicon-chevron-right"></i>数据统计</a>
	                </li>
	                <li>
	                    <a href="/books/time.jsp"><i class="glyphicon glyphicon-chevron-right"></i>定时提醒</a>
	                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">公文流转</div>
                            </div>
    ...
    <div class="row">
                <div class="col-lg-12">
                    <div class="col-lg-4 form-group" style="width:800px;">
                                        <button type="submit" class="btn btn-primary" id="btn_query" >收文</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >归档</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >文档复印</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >分配管理</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >借阅/归还管理</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >销毁管理</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >生命周期检索</button>
                                    </div>
                </div>
            </div>
                <div class="row">
  ...
  %>                 
                            	<tbody>
	                                ...
	                                <td>
<button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="haibook(<%= bean.getHid() %>)">查看详情</button>
	                                </td>                                               
                          	  </tbody>
                             <%} %> 
                        </table>
