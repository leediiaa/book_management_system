    ...
    <div class="row">
                <div class="col-lg-12">
                      <div class="col-lg-4 form-group" style="width:800px;">
                                        <button type="submit" class="btn btn-primary" id="btn_query" >时间</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >密级</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >发文部门</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >文件借出次数</button>
                                    </div>
                </div>
            </div>
                <div class="row">
