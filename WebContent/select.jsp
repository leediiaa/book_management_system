                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">基础信息管理</div>
                            </div>
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                               ...
                               <!--      <div class="col-lg-8 form-group">
                                    ...
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="btn_query" >平台用户管理</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" >数据字典管理</button>
                                        <button type="submit" class="btn btn-primary" id="btn_query" style="margin-left: 230px;margin-top:-35px;">部门/职员管理</button>
                                    </div>
                                </form>
                            </div>
                        </div>
